/* Problema 2: Dada una lista con las edades de N estudiantes y un número natural X, 
ingresado por teclado, se solicita ordenar la lista y luego informar si dicho número se encuentra en la 
lista A ingresada 
*/
#include <stdio.h>
