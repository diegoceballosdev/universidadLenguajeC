...
TAREA - CLASE 2:
a) Modificar el programa para ingresar la lista ordenada segun Apellido y Nombre.
Cargar y mostrar lista.
b) CON REGISTRO ANIDADO
Agregar el campo direccion  (calle/nro) al registro Talumno, cargar y mostrar lista.
*/
