/*EJEMPLO 1: REGISTRO - VECTOR DE REGISTRO 
...
un programa que cargue una lista ordenada por dni y luego mediante un menú:
a) Permitir modificar la nota de un alumno, dado su DNI.
b)Eliminar un alumno de la lista.
c)Mostrar la lista completa.
d) Agregar un alumno preservando el orden.
 */
...
/*
Talumno carga_alumno(){ //Carga Registro (Talumno) sin validar ningún campo
	Talumno aux;
	long dv;
